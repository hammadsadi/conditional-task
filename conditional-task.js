...
let student = false;
let ticketFee = 800;
let seniorCitizensStatus = false;
if (age < 10) {
  console.log("Your Fare is Free");
} else if ((age > 10) & (student === true)) {
  let discount = (ticketFee * 50) / 100;
  let payAmount = ticketFee - discount;
  console.log("Students get a 50% discount, Your Ticket Fee Is :" + payAmount);
} else if (age >= 60 && seniorCitizensStatus === true) {
  let seniorDiscount = (ticketFee * 15) / 100;
  let seniorDiscountAmount = ticketFee - seniorDiscount;
  console.log(
    "You are Senior citizens, Your Ticket Fee is:" + seniorDiscountAmount
  );
} else {
